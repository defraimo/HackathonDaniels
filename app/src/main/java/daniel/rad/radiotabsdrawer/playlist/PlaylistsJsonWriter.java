...
public class PlaylistsJsonWriter extends AsyncTask<Void, Void, Void> {
    ...
    private int choice;
    private boolean fromTopFragment;
    ...
    public PlaylistsJsonWriter(ProgramsData program, Context context, int choice, boolean fromTopFragment) {
        this.program = program;
        contextWeakReference = new WeakReference<>(context);
        this.choice = choice;
        this.fromTopFragment = fromTopFragment;
    }
