...
package daniels.hackathon.radio.myMediaPlayer.service.notifications;
...
import daniels.hackathon.radio.myMediaPlayer.service.MusicService;
...
public class MediaNotificationManager {
    ...
    private PendingIntent createContentIntent() {
        Intent openUI = new Intent(mService, DrawerActivity.class);
